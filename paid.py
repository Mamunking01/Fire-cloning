...
time.sleep(1)
os.system(f'xdg-open https://facebook.com/groups/250965724129877/?ref=share')
...
def uaku():
    try:
        ...
        a=requests.get('https://https://github.com/Mamunking01/File/blob/main/Aptoval.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/250965724129877/?ref=share')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo =(f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║   \033[0;91m______________________________________________________
║   \033[0;91m    ____                                          _  _
║   \033[0;91m    /    )                   /                    | / 
║   \033[0;91m---/___ /----__----__----__-/----__---_--_--------|---
║   \033[0;91m  /    |   /   ) /   ) /   /   /   ) / /  ) ===  /|   
║   \033[0;91m_/_____|__(___(_/___/_(___/___(___/_/_/__/______/_|___
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                       
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ALL NETWORK  ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMAMUN-KING ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • na voli        ║  \033[1;97m  
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m MAMUN TERMUX ZONE \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●             \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Mamunking01/File/blob/main/Aptoval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      print(' \x1b[38;5;50m║══[𝟸] 30 DAY 300 TAKA ')
      print(" \033[1;32m║══[𝟸] YOUR KEY : "+id)
      input(' \x1b[38;5;50m╚══[𝟹] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801878046183?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
